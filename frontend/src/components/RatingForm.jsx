    ...
    <div className="rating-form">
      ...
      <form onSubmit={handleSubmit} className="rating-form-form">
        ...
        <div className="rating-form-field">
          <label className="rating-form-label">Rating</label>
          <div className="rating-form-stars">
            {[1, 2, 3, 4, 5].map((value) => (
              <button
                ...
                className="rating-form-star-button"
            ...
            {rating > 0 && (
              <span className="rating-form-rating-value">
                {rating}/5
              </span>
            )}
          </div>
        ...
        {/* Comment Field */}
        <div className="rating-form-field">
          <label htmlFor="comment" className="rating-form-label">
            Comment (optional)
          </label>
          <textarea
            id="comment"
